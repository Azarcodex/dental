          ...
          <div className="max-w-xl mx-auto bg-white p-6 md:p-10 lg:p-14 rounded-[40px] shadow-xl shadow-primary-blue/5 animate-fade-in text-center space-y-8 relative overflow-hidden">
            ...
            <div className="bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-100 space-y-6">
               <div className="space-y-1">
                  ...
                  <p className="text-4xl sm:text-6xl font-black text-primary-blue tracking-tighter">{successData.token}</p>
               </div>
  ...
  return (
    <section id="booking" className="relative py-20 lg:py-28 bg-slate-50/20 scroll-mt-24">
      ...
      <div className="container-custom relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
        ...
        {/* Right Column: Form */}
        <div className="lg:col-span-8 bg-white rounded-3xl md:rounded-[40px] shadow-2xl shadow-primary-blue/5 overflow-hidden animate-fade-in border border-slate-50">
          ...
          <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="p-6 md:p-10 lg:p-12 space-y-8 md:space-y-12">
            ...
            <div className="space-y-8">
               ...
               <div className="space-y-4 pt-6">
                  ...
                  <div className={cn(
                    "p-5 md:p-8 lg:p-10 rounded-3xl md:rounded-[40px] border-2 transition-all relative min-h-[140px] flex items-center justify-center overflow-hidden",
            ...
            <button 
              ...
              className="w-full btn-primary text-base md:text-lg h-16 md:h-20 rounded-2xl md:rounded-[30px] flex items-center justify-center gap-4 mt-6 group shadow-2xl shadow-primary-green/40 hover:-translate-y-1.5 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:translate-y-0 disabled:shadow-none"
            >
