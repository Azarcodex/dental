    ...
    <section className="py-20 bg-[#f1f5f9]">
      <div className="container-custom">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative rounded-[50px] bg-navy-950 p-12 md:p-20 overflow-hidden"
        >
          {/* Animated Accents */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-primary-green/20 rounded-full blur-[100px] animate-pulse" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-green/10 rounded-full blur-[100px] animate-pulse" />
